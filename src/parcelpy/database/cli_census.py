#!/usr/bin/env python3
"""
Census Integration CLI for ParcelPy Database Module.

Provides command-line interface for integrating Census data with parcel data
using PostgreSQL with PostGIS backend.
"""
