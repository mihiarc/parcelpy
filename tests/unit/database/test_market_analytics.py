...
from parcelpy.database.core.market_analytics import MarketAnalytics
...
class TestMarketAnalytics:
    ...
    @patch('parcelpy.database.core.market_analytics.SKLEARN_AVAILABLE', True)
    ...
    @patch('parcelpy.database.core.market_analytics.SKLEARN_AVAILABLE', False)
